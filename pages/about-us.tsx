          ...
          <div className="flex flex-col lg:flex-row items-center justify-center">
            ...
            <div className="lg:ml-96 lg:mt-0 mt-5">
              ...
              <div className="lg:text-3xl text-xl text-center lg:w-[600px] w-72 lg:mt-10">
                Waroeng Timoer adalah kafe yang menyajikan minuman coffee dan
                juga minuman non coffee yang dibuat oleh barista terbaik kami
                menjamin tempat yang nyaman untuk anak muda dan tempat yang

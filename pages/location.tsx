        ...
        <div className="lg:flex lg:items-center justify-center p-8 bg-white text-black">
          ...
          <div className="lg:ml-[500px] items-center flex flex-col">
            ...
            <div className="text-2xl lg:w-[600px] text-center">
              Temukan kami di Jl. Dewi Kunti, Sumerta Kelod, Denpasar Selatan,
              Kota Denpasar, Bali 80239, Lokasi kami dekat dengan renon dan juga
              kampus warmadewa, cocok bagi anda untuk bersantai dan membuat
              tugas
            </div>
          </div>
        </div>
